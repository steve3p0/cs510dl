...
For this assignment you will implement DCGAN in pytorch. The code is available at this link:
https://pytorch.org/tutorials/beginner/dcgan_faces_tutorial.html

The tutorial is self-explanatory.

What to submit: A report in which you discuss the following:
1. How long did it take you. Any significant challenges?
2. Provide a set of real and fake images
...
Original file is located at
    https://colab.research.google.com/drive/1KliYGKn88H05uA2BntPbg42UhDNkJenT
"""
...
print("####################################################################################################")
print(f"Start : {timestamp_pretty}")
print("####################################################################################################")
